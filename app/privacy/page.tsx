...
const email = siteConfig.company?.email || "privacy@example.com";
const jurisdiction = siteConfig.company?.location ?? "our operating region";
...
export default function PrivacyPolicyPage() {
  return (
    <>
      <main className="mx-auto max-w-3xl px-5 pb-24 pt-32 md:px-8 md:pt-40 text-white/90">
